...
public class BlogService implements IBlogService {
    ...
    @Override
    public List<Blog> findListBlogByName(String name) {
        return blogRepository.findListBlogByName("%"+name+"%");
    }

    @Override
    public Page<Blog> getPageBlog(PageRequest pageRequest) {
        return blogRepository.getPageBlog(pageRequest);
    }
