    ...
    <form method="post" class="m-2">
        <div class="row m-1">
            <div class="col-md-6">
                ...
                <select name="idType" id="idType" class="form-select" onchange="changeCreate(this.value)">
        ...
        <div class="row">
            <div class="col-md-6" id="divStandardRoom">
