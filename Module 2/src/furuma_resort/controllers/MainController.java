...
public class MainController {
    ...
    private static void addNewBooking() {
        ...
        List<DanhBa> listOfService=null;
        switch (chooseModel){
            case 1:
    ...
    public static List<DanhBa> readService(String fileName){
        FileUtils.setPath(fileName);
        List<String> resultReadFile=FileUtils.readFile();
        List<DanhBa> listService=new ArrayList<>();
        DanhBa services=null;
    ...
    private static void showAllServicesNotDuplicate(String fileName) {
        ...
        for (DanhBa services:readService(fileName)){
    ...
    private static void showAllServices(String fileName) {
        ...
        int i;
        List<DanhBa> listReadService=readService(fileName);
        DanhBa services=null;
...
//    }
    ...
    private static void deleteService(String fileName) {
        ...
        List<DanhBa> listServices=readService(fileName);
        listServices.remove(choose-1);
        DanhBa arrayServices;
...
//
    ...
    private static void editService(String fileName) {
        ...
        int choose=Integer.parseInt(scanner.nextLine());
        DanhBa stringService=addNewStringService(fileName);
        List<DanhBa> listServices=readService(fileName);
...
//
    ...
    private static DanhBa addNewStringService(String fileName) {
        String id=null;
